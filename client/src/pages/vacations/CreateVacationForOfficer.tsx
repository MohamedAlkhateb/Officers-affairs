          ...
          <div>
            {selectedOfficer?.value && vacationsCredit ? (
              isVacationsCreditLoading ? (
                ...
                <>
                  {console.log("vacationsCredit: ", vacationsCredit)}
                  <div className="fs-4">
                    <div>
                    ...
                    <div>
                      ...
                      {vacationsCredit[0]?.remainingYearlyVacationsDaysNumber}
                    </div>
                    <div>
                      ايام تستحق بدل راحة:{" "}
              ...
              <div className="d-flex justify-content-center">
                <button
                  ...
                  onClick={() => {
                    ...
                    const diffrenceBetweenFromAndToDates =
                      calculateDiffreneceBetweenDates(to, from);
                    ...
                    if (
                      ...
                      alert("لا يوجد لك رصيد متبقي من السناوية");
                    } else if (
                      selectedVacationType.label ===
                        vacationsTypesEnumInArabic.ergunt &&
                      ...
                      alert(
                        "طلب الاجازة بدل الراحة لا يمكن ان يكون اكثر من يوم"
                      );
                    } else if (
                      selectedVacationType.label ===
                        vacationsTypesEnumInArabic.yearly &&
